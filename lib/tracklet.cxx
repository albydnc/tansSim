...
tracklet::tracklet(const hit &hitL1, const hit &hitL2) : TObject(), _L1(hitL1), _L2(hitL2) {}

tracklet::tracklet(const hit *const phitL1, const hit *const phitL2) : TObject(), _L1(*phitL1), _L2(*phitL2) {}
tracklet::~tracklet() {}
